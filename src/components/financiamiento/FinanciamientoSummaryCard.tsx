...
interface FinanciamientoInfo {
  ...
  progreso: number;
  montoTotal: number;
  cobrosIniciales?: number; // Agregar para mostrar cuotas iniciales
}
...
export const FinanciamientoSummaryCard = ({
  financiamientoInfo,
  productoNombre,
  fechaInicio,
  index,
    ...
    <div className='border border-gray-200 rounded-2xl overflow-hidden hover:shadow-xl transition-all duration-300 bg-white'>
      ...
      <div className='p-6'>
        ...
        <div className='rounded-xl '>
          ...
          {/* Indicadores de estado - CORRIGIDO para mostrar información precisa */}
          ...
          {/* Indicador de cuotas iniciales si las hay */}
          {financiamientoInfo.cobrosIniciales &&
            financiamientoInfo.cobrosIniciales > 0 && (
              <div className='mt-2 text-xs text-purple-600 bg-purple-50 px-2 py-1 rounded-md'>
                💜 {financiamientoInfo.cobrosIniciales} cuota
                {financiamientoInfo.cobrosIniciales > 1 ? "s" : ""} inicial
                {financiamientoInfo.cobrosIniciales > 1 ? "es" : ""} pagada
                {financiamientoInfo.cobrosIniciales > 1 ? "s" : ""}
              </div>
            )}
        </div>
      </div>
