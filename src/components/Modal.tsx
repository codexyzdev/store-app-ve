...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, children, title }) => {
  ...
  return (
    <div
      className='fixed inset-0 z-50 px-2 flex items-center justify-center bg-black/30  overflow-y-auto'
      onClick={onClose}
    ...
    >
      <div
        className='bg-white shadow-2xl rounded-2xl w-full max-w-2xl border border-gray-200 relative my-8 max-h-[97vh] flex flex-col'
