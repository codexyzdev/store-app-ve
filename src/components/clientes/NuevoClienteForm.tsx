    ...
    >
      ...
      <div>
        <label
          ...
          className='block text-sm font-medium text-gray-700 mb-1'
        >
          Foto de la cédula de identidad <span className='text-red-600'>*</span>
        </label>
        <div className='flex flex-col sm:flex-row items-start sm:items-center gap-4'>
          <div className='flex flex-col items-center gap-2'>
            <label className='cursor-pointer px-4 py-2 bg-indigo-600 text-white rounded shadow hover:bg-indigo-700 transition font-medium w-full text-center'>
              Seleccionar imagen
              <input
                type='file'
                id='fotoCedula'
          ...
          {previewUrl && (
            <div className='flex flex-col items-center gap-1'>
              ...
              <img
                src={previewUrl}
                alt='Preview cédula'
                className='border rounded shadow max-w-[120px] max-h-28 aspect-square object-contain bg-white'
              />
            </div>
          )}
        </div>
